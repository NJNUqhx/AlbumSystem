                    ...
                    <td>
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#photos-moment-btn"
                            ...
                            <li class="list-group-item">
                                <button class="btn btn-info">获取动态的评论</button>
                            </li>
                        </ul>
...
export default {
    ...
    setup() {
        ...
        const momentExamine = (moment, handle) => {
            console.log(moment);
            console.log(handle);
        }
